...
// =================== PRESET USINE : SynLead ===================
const byte SYNLEAD_DUMP[] = {
  0xF0, 0x42, 0x30, 0x1D, 0x40,
  0x44, 0x79, 0x6E, 0x6F, 0x50, 0x69, 0x61, 0x6E,
  ...
  0x63, 0x1C, 0x62, 0x00, 0x19, 0x18, 0x06, 0x15,
  0x00, 0x00, 0x00, 0x1F, 0x00, 0x02, 0x00, 0x00,
  0x00, 0x1F, 0x00, 0x06, 0x0E, 0x08, 0x07, 0x08,
  0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01, 0x00,
  0x02, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
  0x00, 0x00, 0x00, 0x00, 0x04, 0x06, 0x02, 0x04,
  0x00, 0x00, 0x03, 0x00, 0xF7
};
const int SYNLEAD_SIZE = sizeof(SYNLEAD_DUMP);
...
void setup() {
  ...
  if (!eepromOk || presetCount == 0) {
    showMessage("1er demarrage", "Chargement SynLead");
    delay(1000);
    presetSlots[0].size  = SYNLEAD_SIZE;
    presetSlots[0].valid = true;
    memcpy(presetSlots[0].data, SYNLEAD_DUMP, SYNLEAD_SIZE);
    strncpy(presetSlots[0].name, "SynLead", 9);
    presetSlots[0].name[9] = '\0';
    presetCount = 1;
    currentSlot = 0;
    eeWriteSlot(0);
    eeSaveMeta();
